package org.spiderdesign.core.utils;
...
import org.spiderdesign.core.service.DataSourceService;
...
public class DataSourceUtils {
	...
	public synchronized static DataSource getDataSource(String dataSourceId){
		DataSource dataSource = datasources.get(dataSourceId);
		if(dataSource == null){
			org.spiderdesign.core.model.DataSource ds = dataSourceService.getById(dataSourceId);
			if(ds != null){
